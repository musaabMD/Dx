    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="flex-grow p-8 pb-20">
        <div className="mb-4">
          ...
          <div className="text-2xl text-black font-semibold" dangerouslySetInnerHTML={{ __html: currentQuestion.question_text }} />
        </div>
        <div className="space-y-4">
          {options.map(({ letter, text }) => {
            const isSelected = answers[currentQuestionIndex] === letter;
            ...
            return (
              ...
              >
                <span 
                  ...
                  className="cursor-pointer"
                >
                   {letter}. <span dangerouslySetInnerHTML={{ __html: text }} />
                </span>
              </button>
            );
          })}
