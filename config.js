...
// //     fromNoReply: `DrNote <support@drnote.co>`,
// //     // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
// //     fromAdmin: `DrNote <support@drnote.co>`,
// //     // Email shown to customer if need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
// //     supportEmail: "support@drnote.co",
// //     // When someone replies to supportEmail sent by the app, forward it to the email below (otherwise it's lost). If you set supportEmail to empty, this will be ignored.
// //     forwardRepliesTo: "support@drnote.co",
// //   },
// //   colors: {
...
//   appName: "DrNote.co",
//   // REQUIRED: a short description of your app for SEO tags (can be overwritten)
//   appDescription: "Qbank For SMLE,SDLE,SPLE,SNLE,SLLE and more.",
//   // REQUIRED (no https://, not trialing slash at the end, just the naked domain)
//   domainName: "DrNote.co",
//   crisp: {
//     // Crisp website ID. IF YOU DON'T USE CRISP: just remove this => Then add a support email in this config file (mailgun.supportEmail) otherwise customer support won't work.
